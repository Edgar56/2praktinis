...
public class Skaiciavimai {
         ...
         private double paskolosSuma;
         private double sutartiesSudarymoMokestisAtsakymas;
         private double  atsakymas1 = 0;
         private double atsakymas2 = 0;
         
         private double paskolosSuma2;
         private double laikotarpis;
         private double bendrosGrazintinosSumosApskaiciavimasAtsakymas;
         
         private double kreditoMenesineImokaApskaiciavimas;
        
         private double realiosMenesinesPajamos;
         private double seimosPajamosAtskaiciusMokescius;
         private double seimosFinansiniaiIsipareigojimai;
         private double vaikuSkaiciusSeimoje;
